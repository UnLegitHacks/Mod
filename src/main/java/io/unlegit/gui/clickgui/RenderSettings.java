...
public class RenderSettings implements IMinecraft
{
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks)
    {
        ...
        graphics.fill(wD - 150, hD - 125, wD + 150, hD + 125, Colorer.RGB(10, 10, 10, 200));
        ...
        IFont.NORMAL.drawString(graphics, module.description, wD - 145, hD - 122, Colorer.RGB(235, 235, 235));
    }
