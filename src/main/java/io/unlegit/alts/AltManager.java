...
public class AltManager extends Screen implements IGui
{
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks)
    {
        ...
        graphics.fill(0, 0, width, height, Colorer.RGB(0, 0, 0, 100));
        ...
        IFont.NORMAL.drawString(graphics, "Left click on any \"alt\" to log into it and play on it.", width - IFont.NORMAL.getStringWidth("Left click on any \"alt\" to log into it and play on it.") - 2, height - 14, Color.LIGHT_GRAY.getRGB());
